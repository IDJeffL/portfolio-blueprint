 ...
 */
export const promptUserForTelemetryPref = async (isInit, config) => {
    const { isTelemetryEnabled } = await prompt.get({
        properties: {
            isTelemetryEnabled: {
                description: 'Would you like to enable telemetry in Faust? This helps us make more informed feature decisions. true/false',
                required: true,
                type: 'boolean',
            },
        },
